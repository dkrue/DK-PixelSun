...
void Adafruit_ST7735::initR(uint8_t options) {
  ...
  } else if((options == INITR_MINI160x80) || (options == INITR_MINI160x80_DKOFFSET)) { // DK ADD
    _height   = ST7735_TFTHEIGHT_160;
    _width    = ST7735_TFTWIDTH_80;
    displayInit(Rcmd2green160x80);
    _colstart = options == INITR_MINI160x80_DKOFFSET ? 26 : 24; // DK ADD Offset
    _rowstart = 0;
  } else {
...
void Adafruit_ST7735::setRotation(uint8_t m) {
  ...
  // For ST7735 with GREEN TAB =-=-=- DK ADD: MINI160x60 WITH GREEN TAB PIXELS WERE OFFSET 8/29/2020
  if((tabcolor == INITR_144GREENTAB) || (tabcolor == INITR_HALLOWING) || (tabcolor == INITR_MINI160x80_DKOFFSET)) {
